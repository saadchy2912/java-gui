...
public class BloodBankFrame extends JFrame {
    ...
    private static final String DATA_FILE = DATA_DIR + "/donors.csv";

    private Color c1, c2;
    private Font f1, f2;
    private JPanel panel;
    private JLabel label1, label2, label3, label4, label5, label6, label7, label8;
    private JLabel label9, label10, label11, label12;
    ...
    public BloodBankFrame() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                "Cannot initialize data file: " + ioe.getMessage(),
        ...
        label7.setBounds(20, 270, 150, 25);
        panel.add(label7);
        ...
        // Height
        label8 = new JLabel("Height (cm)");
        label8.setFont(f2);
        label8.setForeground(c1);
        label8.setBounds(20, 310, 150, 25);
        panel.add(label8);
        tf5 = new JTextField();
        tf5.setFont(f2);
        ...
        // Weight
        label9 = new JLabel("Weight (kg)");
        label9.setFont(f2);
        label9.setForeground(c1);
        label9.setBounds(20, 350, 150, 25);
        panel.add(label9);
        tf6 = new JTextField();
        tf6.setFont(f2);
        ...
        // Last Donation
        label10 = new JLabel("Last Donation (YYYY-MM-DD)");
        label10.setFont(f2);
        label10.setForeground(c1);
        label10.setBounds(20, 390, 300, 25);
        panel.add(label10);
        tf7 = new JTextField();
        tf7.setFont(f2);
        ...
        // Contact
        label11 = new JLabel("Contact Number");
        label11.setFont(f2);
        label11.setForeground(c1);
        label11.setBounds(20, 430, 150, 25);
        panel.add(label11);
        tf8 = new JTextField();
        tf8.setFont(f2);
        ...
        label12 = new JLabel(scaledIcon);
        label12.setBounds(550, 70, 320, 320);
        panel.add(label12);
        ...
        bt1.addActionListener(e -> {
            try {
                ...
                appendToFile(id, name, age, gender, dob, blood, height, weight, last, contact);
                ...
                JOptionPane.showMessageDialog(this, "Failed to save donor: " + ex.getMessage(), "File I/O Error", JOptionPane.ERROR_MESSAGE);
            }
        });
    }
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (t.length == 10) {
                    model.addRow(new Object[]{
                        t[0], t[1], Integer.parseInt(t[2]),
                        t[3], LocalDate.parse(t[4]), t[5],
                        Double.parseDouble(t[6]), Double.parseDouble(t[7]),
                        LocalDate.parse(t[8]), t[9]
                    });
                }
            }
    ...
    private void appendToFile(Object... fields) throws IOException {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(DATA_FILE, true))) {
            for (int i = 0; i < fields.length; i++) {
                bw.write(fields[i].toString());
